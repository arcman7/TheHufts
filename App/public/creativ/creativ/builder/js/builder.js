...
editableItems['.blog-item img.edit'] = [];
editableItems['p'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.form-control, label, .btn, .btn-primary, .tp-caption.slider-title2 span, .footer p, .copyrights h4, .copytext h4, .footer .widget-title h3, .meta span, .meta span a, .blog-desc p, .blog-title h3 a, .myservices .title h3 i, .service-style-1 p, .service-style-1 h3, .mini-title h2 span, .mini-title h2, .myservices .title h3, .icon-container, .breadcrumb > li > a, .boxed h3, .boxed p, .callus .btn, .callus a, .callus .dropdown-menu > li > a, .front i, .front h3, .service-hover i, .service-hover p, .social-icons i, .footer .form-control, .tp-caption.slider-title, .tp-caption.slider-title span, .service-hover h3, .breadcrumb > li, .section-title p, .section-title h3, .tp-caption.slider-title2, .contact-widget ul li, .contact-widget ul li i, .subscribe-form h4'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.square-service h3'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.square-service p'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.icon-container i'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.service_vertical_box .service-icon'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.service_vertical_box .service-icon i'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.team_desc h3'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.team_desc p'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.portfolio-filter li a'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.bf ul.filter li a'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.welcome-message h3'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.owl-item h3'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.owl-item p'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.box-wrap .back h3'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.box-wrap .back i'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.box-wrap i'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.box-wrap h3'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.shortcode-widget p'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.progress > .progress-type'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.progress > .progress-completed'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.services_vertical h3'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.services_vertical p'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['#accordion-first .accordion-heading .accordion-toggle'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.accordion-inner p'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.social'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['blockquote, .social i'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.metabox, .metabox a'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.cap-in p, .cap-in h3, .cap-in h3 a, .item figure h2, figure.effect-chico p, .portfolio-meta h3, .portfolio-meta p, .portfolio-desc p, .portfolio-title h3, #sidebar .featured-widget h3 a, .testi-sidebar p, .testi-sidebar small'] = ['color', 'font-size', 'background-color', 'font-family'];

editableItems['.single-blog-title, .single-blog-desc'] = ['color', 'font-size', 'font-family'];
...
var editableContent = ['.cap-in p, .cap-in h3, .cap-in h3 a, .item figure h2, figure.effect-chico p, .portfolio-meta h3, .portfolio-meta p, .portfolio-desc p, .portfolio-title h3, .single-blog-desc, .single-blog-title, .tldate, blockquote, .widget-title h3, .testi-sidebar p, .testi-sidebar small, .metabox, .metabox a, #sidebar .featured-widget h3 a, .social i', '.social', '.accordion-inner p', '#accordion-first .accordion-heading .accordion-toggle', '.services_vertical h3', '.services_vertical p', '.progress > .progress-completed', '.progress > .progress-type', '.shortcode-widget p', '.box-wrap i', '.box-wrap .back h3', '.box-wrap .back i', '.box-wrap h3', '.owl-item p', '.owl-item h3', '.welcome-message h3', '.bf ul.filter li a', '.portfolio-filter li a', '.team_desc p', '.team_desc h3', '.service_vertical_box .service-icon', '.service_vertical_box .service-icon i', '.icon-container i', '.square-service h3', '.square-service p', 'label', '.form-control', '.btn', '.btn-primary', '.tp-caption.slider-title span', '.copytext h4', '.footer .form-control', '.footer p', '.copyrights h4', '.contact-widget ul li', '.contact-widget ul li i', '.subscribe-form h4', '.footer .widget-title h3', '.blog-title h3 a', '.meta span', '.meta span a', '.blog-desc p', '.myservices .title h3', '.mini-title h2', '.mini-title h2 span', '.service-style-1 p', '.service-style-1 h3', '.myservices .title h3 i', '.boxed h3', '.icon-container', '.boxed p', '.breadcrumb > li', '.breadcrumb > li > a', '.callus .dropdown-menu > li > a', '.callus .btn, .callus a', '.social-icons i', '.callus .btn', '.tp-caption.slider-title2', '.tp-caption.slider-title2 span', '.section-title h3', '.section-title p', '.front i', '.front h3', '.service-hover i', '.service-hover p', '.editContent', '.service-hover h3', '.tp-caption.slider-title', '.navbar a', 'button', 'a.btn', '.footer a:not(.fa)', '.tableWrapper'];
